...
if __name__ == '__main__':
    ...
    print("Opening Maestro Controller")
    # windows interface example
    maestro = Controller("COM5")
    maestro.setAccel(0,10)
    maestro.setSpeed(0,10)

    asdf = maestro.getPosition(0)

    print("Setting channel 0 to 6000 (1.5ms)")
    maestro.setTarget(0,6000)
    time.sleep(2)

    print("Setting channel 0 to 8000 (2.0ms)")
    maestro.setTarget(0,8000)
    time.sleep(2)

    print("Setting channel 0 to 4000 (1.0ms)")
    ...
    print("Closing Maestro Controller")
    maestro.close()
